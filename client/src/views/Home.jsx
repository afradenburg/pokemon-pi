...
const Home = () => {
  ...
  const currentElements = Array.isArray(allPokemons)
    ? allPokemons.slice(startIndex, endIndex)
    : allPokemons;
  const totalPages = allPokemons
    ? Math.ceil(allPokemons.length / elementsPage)
    : 0;
